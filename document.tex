...
% Enable use of glossary and acronym indexing using a separate file.
\makeglossaries
...
\begin{document}
  ...
  % Insert/refer to task source/PDF .
  % \includepdf[pages=-]{<<PDF file name>>}
  ...
  % List of terms
  % \newpage
  % \printglossary[title=Glossary, toctitle=Glossary]\label{sec:glossary}

  % \newpage
  % \printglossary[type=\acronymtype]\label{sec:acronym}
...
%   \pagenumbering{arabic}
%   \setcounter{page}{1}
%   % \includepdf[pages=-]{Tutorial1.pdf}

  
%   \newpage
%     \begin{center}
%       {\bfseries{\Huge{Tutorial Answers}}}  
%     \end{center}
%   \input{tex/03_body_section1.tex}
